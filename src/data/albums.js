export default [{
  ...
  slug: 'the-colors',
  songs: [
      { title: '1Blue', duration: '161.71', audioSrc: '/assets/music/blue.mp3' },
      { title: '1Green', duration: '103.96', audioSrc: '/assets/music/green.mp3' },
      { title: '1Red', duration: '268.45', audioSrc: '/assets/music/red.mp3' },
      { title: '1Pink', duration: '153.14', audioSrc: '/assets/music/pink.mp3' },
      { title: '1Magenta', duration: '374.22', audioSrc: '/assets/music/magenta.mp3' }
  ]
}, {
    title: 'The Telephone',
